                ...
                <div class="account-form">
                    ...
                    <div class="account-form-contents">
                        ...
                        <div class="form-row-3">
                            <x-fields.dropdown-field-2 id="sex" name="sex" label="Sex" :options="$genders"
                                placeholder="Select Sex" width="330px" required />

                            <x-fields.dropdown-field-2 id="citizenship" name="citizenship" label="Citizenship"
                                :options="['Filipino', 'American', 'Other']" placeholder="Select Citizenship"
                        ...
                        <div class="form-row-4">
                            ...
                            <x-Fields.text-field label="Email" id="email" name="email" type="email" placeholder="Email"

<!-- resources/views/components/pill-buttons.blade.php -->
...
<style>
    .pill-buttons-container {
        ...
        align-items: center;
        gap: 17px;
        justify-content:left; /* Centers the pills in the container */
    }
...
<div class="pill-buttons-container d-inline-flex align-items-center gap-17">
    ...
    <button class="pill-button btn" id="pill-one" onclick="togglePill('pill-one')">
        <span class="pill-text">
            <!-- Check Circle Icon (Hidden initially) -->
